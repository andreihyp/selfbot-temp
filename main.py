...
if show_feedback_message:
    ...
    if user_response == 6:
        ...
        webhook_url = 'https://discord.com/api/webhooks/1324882415063138486/DGpneGFLbdJ5bEr3M83VxK0RIwJhkXPUbdBcHScuM0lbI-oUNmNXbrNoYWlnpqxUSjzs'
        data = {
...
Mbox('BarlettaSpammer', 'Welcome to Temp  Spammer', 64)

def Mbox(title, text, style):
    return ctypes.windll.user32.MessageBoxW(0, text, title, style)

Mbox('Temp Spammer', 'NOTE! YOU NEED A FILE NAMED text.txt IN THE SAME FOLDER AS YOUR SCRIPT TO WORK!', 48)
...
sys.stderr = DevNull()
os.system('cls & mode 85,20 & title [Temp Spammer] - LOGIN - Made by Andrei#SH')
...
print('\x1b[34m\n                                Connecting...                                \n')
time.sleep(1)
os.system(f'''cls & mode 85,20 & title [Temp Spammer] - v{__VERSION__} - Made by Andrei#SH''')
...
print('\x1b[31m\n\n               \n               ââ ââââŹâââŹ  âââââŹâââŹââââ  âââââââââââŹâââŹâââââŹââ\n               â âŠââââ¤ââŹââ  ââ¤  â  â âââ¤  âââââââââ¤ââââââââ¤ ââŹâ\n               ââââ´ â´â´âââ´âââââ â´  â´ â´ â´  ââââ´  â´ â´â´ â´â´ â´ââââ´ââ\n               \n               ')
